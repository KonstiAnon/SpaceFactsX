...
public record Launch(Date launchDate, String rocketId, boolean success, JSONArray capsules, JSONArray crew,
    ...
    public String toString() {
        ...
        try {
            ...
            return "There was a fatal error getting information about the rocket";
        }
        ...
        str.append("The mission is " + (crew.length() != 0 ? "manned and the crew consists of " + crew.length() + " people" : "unmanned") + "\n");
        str.append("The amount of cores used is: " + cores.length() + "\n");
        if (rocket != null) {
            str.append("The rocket used is of type: " + rocket.name() + "\n");
            str.append("The cost of launching the rocket is approximately: $" + rocket.costPerLaunch() + "\n");
